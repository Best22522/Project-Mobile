...
class Paygraph extends StatefulWidget {
  final String userId;

  const Paygraph({Key? key, required this.userId}) : super(key: key);

  @override
  _PayGraphState createState() => _PayGraphState();
}

class _PayGraphState extends State<Paygraph> {
    ...
    sideTitles: SideTitles(showTitles: false),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text(
                          "รายจ่ายรวม: ${totalAmount.toStringAsFixed(2)} บาท",
